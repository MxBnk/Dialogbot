...
public class RedmineConfig {
    private static final String TEST_PROPERTIES = "redmine_api.properties";
    ...
    private void loadProperties() {
        InputStream is = RedmineConfig.class.getClassLoader().getResourceAsStream(
                TEST_PROPERTIES);
        if (is == null) {
